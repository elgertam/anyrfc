...
class IMAPParser(RFCParser):
    ...
    def _extract_fetch_attributes(self, fetch_att_list, result: IMAPFetchResponse, original_tree=None, original_text=None):
            ...
            if first_token.startswith('"'):
                ...
                for element in elements:
                    if element.startswith('('):
                        ...
                        if potential_subtype in ['ALTERNATIVE', 'MIXED', 'RELATED', 'PARALLEL', 'SIGNED', 'ENCRYPTED']:
