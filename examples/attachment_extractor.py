    ...
    try:
        ...
        for i, email in enumerate(emails_with_attachments, 1):
            ...
            for j, attachment in enumerate(email['attachments'], 1):
                ...
                print(f"      Type: {attachment.get('media_type', 'unknown')}/{attachment.get('media_subtype', 'unknown')}")
                ...
                if j == 1:  # Only extract first attachment
                    print(f"      🔄 Attempting to extract BLOB...")
                    ...
                    for part_num in ['2', '1.2', '2.1']:
                        ...
                        print(f"      ❌ Could not extract attachment BLOB")
